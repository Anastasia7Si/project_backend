...
Revision ID: 87385b4e838a
Revises: 
Create Date: 2023-12-03 04:58:27.596584
...
def upgrade() -> None:
    ...
    op.execute("CREATE TYPE status_type AS ENUM ('markup', 'unclaimed', 'postponed', 'waiting')")
    ...
    sa.Column('status', postgresql.ENUM('markup', 'unclaimed', 'postponed', 'waiting', name='status_type'), nullable=True),
